...
* 具体的物理实现：
  ...
  * UE之间使用固定信道进行通讯，具体细节:arrow_right:BS为D2D划分一固定信道
...
* 将D2D的过程分为多次CRG，每次的动作相同：
  1. UE将自己所拥有的layer、自己所需求的layer和地理位置报告BS
  2. 在获得UE的情况后，BS使用“同时进入餐厅、信息完全”的CRG模型，为每个UE做出选择：售卖某个layer或是购买自己需要且还没有满足的layer。
  3. BS把为UE做出的选择告诉对应UE
  4. UE之间通过D2D来完成layer的售卖和购买。
* 该模型的分析：
  * ![image-20200116132427725](https://s2.ax1x.com/2020/01/16/lv9nds.png)
  * BS通过迭代来获得纳什均衡or接近纳什均衡
  * 如何证明迭代可以获得/接近纳什均衡
